...
// import imageDates from 'src/date/imageDatas.json'

// 获取图片相关的数据
let imageDatas;
imageDatas = require('../date/imageDatas.json');
...
class ImgFigure extends React.Component{
    ...
    render(){
        ...
        if (this.props.arrange.rotate){
            ['MozTransform', 'msTransform', 'WebkitTransform','transform','transform'].forEach((value) =>{
